...
<div class="tekstipohja2">
    <div class="palkki">
        <a href="infoapupalvelu.php" class="backbutton"><i class="fa fa-arrow-circle-left 2x"></i> Takaisin</a>
    </div>
<!--tämä header muille sivuille kuin indexiin-->
<h2>Apupalvelun tilaaminen</h2>
<p>Tilaa tästä apupalvelu.</p>
<br>
...
<?php
    ...
    <div class="col-75">
      <select id="Lisäpalvelu" name="service" required>
        <option value="">Valitse tästä apupalvelusi</option>
        <option value="hyllyn kokoaminen">Hyllynkokoaminen (hinta ...)</option>
        <option value="koiran ulkoiluttaminen">Koiran ulkoiluttaminen (hinta ...)</option>
        <option value="kodin siivoaminen">Kodin siivoaminen (hinta ...)</option>
...
<?php
    ...
    <div class="col-75">
      <select id="Lisäpalvelu" name="service" required>
        <option value="">Valitse tästä apupalvelusi</option>
        <option value="hyllynkokoaminen">Hyllynkokoaminen (hinta ...)</option>
        <option value="koiran ulkoiluttaminen">Koiran ulkoiluttaminen (hinta ...)</option>
        <option value="kodin siivoaminen">Kodin siivoaminen (hinta ...)</option>
        <option value="muu">Muu (kirjoita tarkemmin aiheeseen)</option>
      </select>
