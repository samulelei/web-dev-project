...
<!--tämä header muille sivuille kuin indexiin-->
        <div>
            <h2>Remonttipalvelut</h2>
        </div>
        <div class="container">
            <div class=tekstialue>
                <p>Tarvitsetko apua remonteissa? Kontulan Huolto auttaa mahdollisissa remonteissa, kuten seinän maalaamisessa.</p>
            </div>
            <h3>Hinnasto</h3>
...
<table>
  ...
  <tr>
    <td>Seinän maalaaminen</td>
    <td>10 euroa/tunti</td>
    <td>Kontulan Huollon ammattisiivoojat auttavat sinua seinän maalaamisessa.</td>
  </tr>
  <tr>
    <td>Kodinkoneiden asentaminen</td>
    <td>10 euroa/tunti</td>
    <td>Kodinkoneiden asentamiseen auttavia käsiä.</td>
  </tr>
  <tr>
    <td>Sähkötöiden tekeminen</td>
    <td>10 euroa/tunti</td>
    <td>Sähkötyöt ammattilaisille.</td>
  </tr>
  </table>

  <form action="remonttipalvelu.php">
      <br>
    <input type="submit" value="Tilaa remonttipalvelu!" />
        </form>
        </div>
</div>
<!-- Footer -->
