...
<div class="tekstipohja2">
    <div class="palkki">
        ...
        <div>
            <h2>Tilojen ajanvaraus</h2>
        </div>
        <div class="container">
            <div class=tekstialue>
                <p>Täältä pääset varaamaan sauna- ja pyykkivuoroja.</p>
            </div>
            <div class="iconialue">
                <div class="content2">   
                        <a href="saunavaraus.php"><img class="kuvake" src="icons/sauna1.png" alt="Saunavuoro">
                        <p class="icontext">Saunavuoro</p></a>
                </div>
                <div class="content2">
                        <a href="pesu.php"><img class="kuvake" src="icons/pesutupa1.png" alt="Pesuvuoro">
                        <p class="icontext">Pyykkivuoro</p></a>
                </div>
            </div>
        </div>
</div>
