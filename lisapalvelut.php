...
<!--tämä header muille sivuille kuin indexiin-->
        <div>
            <h2>Kontulan Huollon lisäpalvelut</h2>
        </div>
        <div class="container">
            <div class=tekstialue>
                <p>Kontulan huollon lisäpalvelut on tehty auttamaan asukkaita arjen askareissa.</p>
            </div>
            <div class="iconialue">
                <div class="content2">   
                        <a href="inforemontti.php"><img class="kuvake" src="icons/remonttipalvelut1.png" alt="Remonttipalveluiden tilaus">
                        <p class="icontext">Remonttipalvelut</p></a>
                </div>
                <div class="content2">
                        <a href="infoapupalvelu.php"><img class="kuvake" src="icons/apupalvelut1.png" alt="Apupalveluiden tilaus">
                        <p class="icontext">Arjen apupalvelut</p></a>
                </div>
            </div>
        </div>
</div>
